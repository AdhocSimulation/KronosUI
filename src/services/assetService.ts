...
const mockAssets: Asset[] = [
  ...
  { symbol: 'MSFT', name: 'Microsoft Corporation', type: 'stock', basePrice: 380 },
  { symbol: 'AMZN', name: 'Amazon.com Inc.', type: 'stock', basePrice: 170 },
  { symbol: 'META', name: 'Meta Platforms Inc.', type: 'stock', basePrice: 480 },
  { symbol: 'NVDA', name: 'NVIDIA Corporation', type: 'stock', basePrice: 850 },
  { symbol: 'TSLA', name: 'Tesla Inc.', type: 'stock', basePrice: 175 },
  { symbol: 'JPM', name: 'JPMorgan Chase & Co.', type: 'stock', basePrice: 175 },
  ...
  { symbol: 'UNH', name: 'UnitedHealth Group Inc.', type: 'stock', basePrice: 475 },
  { symbol: 'HD', name: 'The Home Depot Inc.', type: 'stock', basePrice: 375 },
  { symbol: 'BAC', name: 'Bank of America Corp.', type: 'stock', basePrice: 35 },
